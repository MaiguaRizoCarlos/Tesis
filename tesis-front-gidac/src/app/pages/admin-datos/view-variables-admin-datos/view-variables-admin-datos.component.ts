...
import { AgregarUnidadMedidaVariable } from '../../admin/view-variables-admin/view-variables-admin.component';

@Component({
  selector: 'app-view-variables-admin-datos',
  templateUrl: './view-variables-admin-datos.component.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class ViewVariablesAdminDatosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    openDialogAgregarEquivalencia(): void {
      const dialogRef = this.dialog.open(DialogAddEquivalenciaAdminDatos, {});
    ...
    openDialogEditarEquivalencia(id:any): void {
      const dialogRef = this.dialog.open(DialogEditarEquivalenciaAdminDatos, {
        data: { idVariable: id},
      });
      dialogRef.afterClosed().subscribe(() => {
        this.listarVigentes();
    ...
    openDialogCompletarDatos(id:any, nombre:any): void {
      const dialogRef = this.dialog.open(DialogCompletarDatosVariableAdminDatos, {
    ...
    openViewVariableSistema(id:any, nombre:any): void {
      const dialogRef = this.dialog.open(ViewCatalogoVariableAdminDatos, {
        data: { idVariable: id, nombreVariable:nombre},
      });
      dialogRef.afterClosed().subscribe(() => {
        this.listarVigentes();
    ...
    openViewUnidadMedidaVariable(id:any, nombre:any): void {
      const dialogRef = this.dialog.open(ViewUnidadMedidavariableAdminDatos, {
        data: { idVariable: id, nombreVariable:nombre},
      });
    }
...
@Component({
  selector: 'add-equivalencia-variable-admin-datos',
  templateUrl: 'add-equivalencia-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class DialogAddEquivalenciaAdminDatos {
  constructor(
    
    public dialogRef: MatDialogRef<DialogAddEquivalenciaAdminDatos>,
...
@Component({
  selector: 'agregar-unidad-medida-variable-admin-datos',
  templateUrl: 'agregar-unidad-medida-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})

export class AgregarUnidadMedidaVariableAdminDatos {
  constructor(
    public dialogRef: MatDialogRef<AgregarUnidadMedidaVariableAdminDatos>,
    private medidaService:MedidaService,
    private snack: MatSnackBar
  ) { }
...
@Component({
  selector: 'editar-equivalencia-variable-admin-datos',
  templateUrl: 'editar-equivalencia-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class DialogEditarEquivalenciaAdminDatos {
  constructor(
    
    public dialogRef: MatDialogRef<DialogEditarEquivalenciaAdminDatos>,
...
@Component({
  selector: 'view-equivalencia-catalogo-variable-admin-datos',
  templateUrl: 'view-equivalencia-catalogo-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class ViewCatalogoVariableAdminDatos {
  constructor(
    
    public dialogRef: MatDialogRef<ViewCatalogoVariableAdminDatos>,
    @Inject(MAT_DIALOG_DATA) public datos: DatosActualizar,
    private catalogoOrganizacionService:CatalogoOrganizacionService,
  ) { }
...
@Component({
  selector: 'completar-datos-variable-admin-datos',
  templateUrl: 'completar-datos-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class DialogCompletarDatosVariableAdminDatos {
  constructor(
    
    public dialogRef: MatDialogRef<DialogCompletarDatosVariableAdminDatos>,
    private snack: MatSnackBar,
    @Inject(MAT_DIALOG_DATA) public datos: DatosActualizar,
    private service: TipoProyectoService,
    private catalogoOrganizacionService:CatalogoOrganizacionService,
...
@Component({
  selector: 'view-unidad-medida-variable-admin-datos',
  templateUrl: 'view-unidad-medida-variable-admin-datos.html',
  styleUrls: ['./view-variables-admin-datos.component.css']
})
export class ViewUnidadMedidavariableAdminDatos {
  constructor(
    
    public dialogRef: MatDialogRef<ViewUnidadMedidavariableAdminDatos>,
    @Inject(MAT_DIALOG_DATA) public datos: DatosActualizar,
