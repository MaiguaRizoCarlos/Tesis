...
@Component({
  selector: 'app-parcela-director',
  templateUrl: './parcela-director.component.html',
  styleUrls: ['./parcela-director.component.css']
})
export class ParcelaDirectorComponent implements OnInit {
