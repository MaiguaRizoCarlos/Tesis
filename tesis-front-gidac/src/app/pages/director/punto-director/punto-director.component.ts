...
@Component({
  selector: 'app-punto-director',
  templateUrl: './punto-director.component.html',
  styleUrls: ['./punto-director.component.css']
})
export class PuntoDirectorComponent implements OnInit {
